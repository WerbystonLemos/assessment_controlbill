            ...
            <form action="{{ route('registerBill.edit')}}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control border-0 " id="input_sacador" name="input_sacador" aria-describedby="sacador_dica" value="">
                    </div>

                    <div class="col-md-6">
                        <label for="input_descricao" class="form-label">Descirção</label>
                        <input type="text" class="form-control border-0 " id="input_descricao" name="input_descricao" aria-describedby="descricao_dica">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control border-0 " id="input_vlr_total" name="input_vlr_total" aria-describedby="vlr_total_dica">
                    </div>

                    <div class="col-md-2">
                        <label for="input_vlr_parcela" class="form-label">Valor da parcela</label>
                        <input type="number" class="form-control border-0 " id="input_vlr_parcela" name="input_vlr_parcela" aria-describedby="vlr_parcela_dica">
                    </div>

                    <div class="col-md-2">
                        <label for="input_dt_vencimento" class="form-label">DT Vencimento</label>
                        <input type="date" class="form-control border-0 " id="input_dt_vencimento" name="input_dt_vencimento" aria-describedby="vencimento_dica">
                    </div>

                    <div class="col-md-2">
                        <label for="input_qtd_parcelas" class="form-label">QTD Parcelas</label>
                        <input type="number" class="form-control border-0 " id="input_qtd_parcelas" name="input_qtd_parcelas" aria-describedby="parcelas_dica">
                    </div>

                    <div class="col-md-2">
                        <label for="input_dt_pagamento" class="form-label">Pago em</label>
                        <input type="date" class="form-control border-0 " id="input_dt_pagamento" name="input_dt_pagamento" aria-describedby="dt_pagamento_dica">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select id="input_responsavel" name="input_responsavel" class="form-select">
