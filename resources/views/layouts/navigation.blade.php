...
<nav x-data="{ open: false }" class="">
    ...
    <div id="containerNavigation" class="">
        <div class="h-16">
            ...
            <!-- Settings Dropdown -->
            <div id="containerNavigationPerfil" class="hidden sm:flex sm:items-center sm:ms-6">
            ...
            <!-- Hamburger -->
            <div id="containerMenuHamburger" class="-me-2 flex items-center sm:hidden">
    ...
    <div id="containerMenuResponisive" :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('registerBill')" :active="request()->routeIs('registerBill')">
                <i class="bi bi-plus-circle-fill"></i> {{ __('Cadastrar Despesa') }}
            </x-responsive-nav-link>
        </div>
